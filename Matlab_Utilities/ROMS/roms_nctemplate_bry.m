function info = roms_nctemplate_bry(spherical,WSEN)
%=========================================================================%
% info = roms_nctemplate_ini(spherical,WSEN)
% 
% Generate a structure containing dimension and variable information of a
% typical ROMS boundary conditions NetCDF file.  Dimension lengths and
% variable values are initially blank, but can be set manually.
% 
% Alternately, calling roms_ncgen_bry will generate a template boundary
...
% Attributees
info.atts = {'type','BOUNDARY file'; ...
             'history',['Initialized by roms_nctemplate_bry at ' datestr(now) '.'] ...
            };
...
for i=1:numel(out_vars)
  if(WSEN(1))
    info.vars(end+1).name = [out_vars{i} '_west'];
    info.vars(end  ).info = {'type','NC_DOUBLE'; ...
                             'dimid',[out_dim2{i} 9]; ...
                             'long_name',[out_long{i} ', western boundary condition']; ...
                             'units',out_unit{i}; ...
                             'time','bry_time'; ...
                             'coordinates',[grd_vars{1} '_' out_cord{out_dims{i}(1)+1} '_west, ' grd_vars{2} '_' out_cord{out_dims{i}(1)+1} '_west, bry_time'] };
  end
  if(WSEN(3))
    info.vars(end+1).name = [out_vars{i} '_east'];
    info.vars(end  ).info = {'type','NC_DOUBLE'; ...
                             'dimid',[out_dim2{i} 9]; ...
                             'long_name',[out_long{i} ', eastern boundary condition']; ...
                             'units',out_unit{i}; ...
                             'time','bry_time'; ...
                             'coordinates',[grd_vars{1} '_' out_cord{out_dims{i}(1)+1} '_east, ' grd_vars{2} '_' out_cord{out_dims{i}(1)+1} '_east, bry_time'] };
  end
  if(WSEN(2))
    info.vars(end+1).name = [out_vars{i} '_south'];
    info.vars(end  ).info = {'type','NC_DOUBLE'; ...
                             'dimid',[out_dims{i} 9]; ...
                             'long_name',[out_long{i} ', southern boundary condition']; ...
                             'units',out_unit{i}; ...
                             'time','bry_time'; ...
                             'coordinates',[grd_vars{1} '_' out_cord{out_dims{i}(1)+1} '_south, ' grd_vars{2} '_' out_cord{out_dims{i}(1)+1} '_south, bry_time'] };
  end  
  if(WSEN(4))
    info.vars(end+1).name = [out_vars{i} '_north'];
    info.vars(end  ).info = {'type','NC_DOUBLE'; ...
                             'dimid',[out_dims{i} 9]; ...
                             'long_name',[out_long{i} ', northern boundary condition']; ...
                             'units',out_unit{i}; ...
                             'time','bry_time'; ...
                             'coordinates',[grd_vars{1} '_' out_cord{out_dims{i}(1)+1} '_north, ' grd_vars{2} '_' out_cord{out_dims{i}(1)+1} '_north, bry_time'] };
  end  
