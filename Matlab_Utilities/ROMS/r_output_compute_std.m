function status = r_output_compute_std(output_dir, output_prefix, var_list)
%=========================================================================%
% status = r_output_compute_std(output_dir, output_prefix)
...
info_out.Attributes(2).Value = ['Generated by r_output_compute_std on ' datestr(now)];
