function info = roms_nctemplate_ini(spherical)
%=========================================================================%
% info = roms_nctemplate_ini
% 
...
% 
% Alternately, calling roms_ncgen_ini will generate a template initial 
...
%=========================================================================%
  ...
  % The attributes
  info.atts = {'type','INITIALIZATION file';...
               'history',['generated by roms_nctemplate_ini.m on ' datestr(now) '.']};
